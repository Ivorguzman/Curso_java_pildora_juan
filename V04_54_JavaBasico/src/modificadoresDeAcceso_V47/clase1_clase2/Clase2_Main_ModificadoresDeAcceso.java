package modificadoresDeAcceso_V47.clase1_clase2;

import modificadoresDeAcceso_V47.paquetePruebas.V47_Clase3_PaquetePruebas;

public class Clase2_Main_ModificadoresDeAcceso {

	public static void main(String[] args) {

		// Instanciando de Clase1
		Clase1_ModificadoresDeAcceso miobj = new Clase1_ModificadoresDeAcceso();
